...
namespace SubtitleTools.UI
{
    ...
    public static class DispatcherExtensions
    {
        ...
        ///     dispatcher
        /// </exception>
        public static void Dispatch<TDependencyObject>(this TDependencyObject dependencyObject, Action<TDependencyObject> action) 
        ...
        ///     dispatcher
        /// </exception>
        public static void Dispatch<TDependencyObject>(this TDependencyObject dependencyObject, DispatcherPriority dispatcherPriority, Action<TDependencyObject> action)
            where TDependencyObject : DependencyObject
        {
            if (dependencyObject == null)
            {
        ...
        ///     dispatcher
        /// </exception>
        public static void Dispatch(this DependencyObject dependencyObject, DispatcherPriority dispatcherPriority, Action action)
        {
            if (dependencyObject == null)
            {
                throw new ArgumentNullException(nameof(dependencyObject));
